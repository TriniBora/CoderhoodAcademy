...
let numeros = function(limite, final) {
    ...
    console.log(`La cantidad de números múltiplos de 3 es: ${ contadorDeMultiplos }`);
    console.log(`La suma de los números desde 0 hasta que termina el recorrido es ${suma}`);
